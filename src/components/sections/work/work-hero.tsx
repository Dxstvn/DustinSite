...
export function WorkHero() {
  return (
    <section
      ...
      data-theme="dark"
      className="dark relative flex min-h-[50vh] flex-col items-center justify-center overflow-hidden px-4 sm:px-6 md:min-h-[60vh] lg:px-8"
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-4xl text-center">
        ...
        >
          Digital products, platforms, and experiences we&apos;ve crafted for
